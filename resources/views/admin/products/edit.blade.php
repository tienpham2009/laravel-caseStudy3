                        ...
                        <div class="col-6">
                            <form method="post" enctype="multipart/form-data" action="{{ route('Product.update' , $product->id)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('input_date') is-invalid @enderror" name="input_date"  value="{{ $product->input_date }}" >
                                </div>
                                @error('input_date')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('expiration_date') is-invalid @enderror" name="expiration_date"  value="{{ $product->expiration_date	 }}" >
                                </div>
