                        ...
                        <div class="col-6">
                            <form method="post" enctype="multipart/form-data" action="{{ route('Product.update') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('origin') is-invalid @enderror" name="origin"  value="{{ $product->origin }}" >
                                </div>
                                @error('origin')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('expiry_date') is-invalid @enderror" name="expiry_date"  value="{{ $product->	input_date }}" >
                                </div>
                                @error('expiry_date')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('expiry_date') is-invalid @enderror" name="expiry_date"  value="{{ $product->expiration_date	 }}" >
                                </div>
                                @error('expiry_date')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('amount') is-invalid @enderror" name="amount"   value="{{ $product->amount }}">
                                </div>
                                @error('amount')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('unit_price') is-invalid @enderror" name="unit_price"  value="{{ $product->unit_price}}" >
                                </div>
                                @error('unit_price')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control @error('image') is-invalid @enderror" name="image"  value="{{ $product->unit }}">
                                </div>
                                @error('image')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
